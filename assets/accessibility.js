(() => {
  ...
  style.textContent = `
    ...
    .mt-mobile-more-nav{position:relative;display:inline-flex;align-items:center}.mt-mobile-more-toggle{color:var(--text-muted);font:inherit;font-size:.92rem;font-weight:900;padding:8px 15px;border-radius:10px;border:1px solid rgba(200,164,90,.22);background:rgba(200,164,90,.08);white-space:nowrap}.mt-mobile-more-toggle[aria-expanded=true]{color:var(--gold-light);border-color:rgba(200,164,90,.42);background:rgba(200,164,90,.16)}.mt-mobile-more-menu{position:absolute;top:calc(100% + 10px);inset-inline-end:0;z-index:500;min-width:220px;padding:8px;border-radius:15px;border:1px solid rgba(200,164,90,.2);background:rgba(12,12,15,.985);box-shadow:0 18px 34px rgba(0,0,0,.36);display:grid;gap:4px}.mt-mobile-more-menu[hidden]{display:none!important}.mt-mobile-more-menu a,.mt-mobile-more-menu .maqam-nav-item>a{width:100%;text-align:start;justify-content:flex-start}.site-nav .nav-links{align-items:center}.site-nav .nav-links>a{font-size:1rem;font-weight:800;padding:9px 16px}.site-nav .nav-main-group{flex-direction:row!important;align-items:center!important}.site-nav .nav-top,.site-nav .nav-top-home{min-height:82px}.site-nav .nav-logo{font-size:2.7rem}.site-nav .nav-logo-mark{width:46px;height:46px}
    @media(max-width:980px){.site-nav .nav-top,.site-nav .nav-top-home{min-height:auto;padding:8px 0}.site-nav .nav-main-group{flex-direction:row!important;align-items:center!important;gap:12px}.site-nav .nav-logo{font-size:1.85rem}.site-nav .nav-logo-mark{width:32px;height:32px}.site-nav .nav-links{gap:4px}.site-nav .nav-links>a{font-size:.84rem;padding:7px 10px}.site-nav .mt-mobile-more-toggle{font-size:.82rem;padding:7px 11px}.site-nav .mt-mobile-more-menu{min-width:190px}}
    @media(max-width:640px){.mt-accessibility-launcher{right:14px;bottom:14px;width:48px;height:48px}.mt-accessibility-panel{right:14px;bottom:72px;width:min(320px,calc(100vw - 20px))}.site-nav .nav-top,.site-nav .nav-top-home{min-height:auto;padding:7px 0 8px}.site-nav .nav-main-group{gap:7px}.site-nav .nav-logo{font-size:1.55rem;gap:7px}.site-nav .nav-logo-mark{width:28px;height:28px}.site-nav .nav-links{gap:4px;align-items:center}.site-nav .nav-links>a{padding:6px 9px;font-size:.78rem}.site-nav .mt-mobile-more-toggle{padding:6px 10px;font-size:.78rem}body.mt-library-mobile .filters{position:static!important;top:auto!important;z-index:1!important}}
  `;
