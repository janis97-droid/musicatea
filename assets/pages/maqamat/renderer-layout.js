(function () {
  ...
  function injectAccordionStyles() {
    ...
    s.textContent = `.maqam-definition-card{padding:14px 16px!important}.maqam-definition-card>h3{display:none!important}.maqam-acc-root,.maqam-sub-accordion{display:grid!important;gap:10px!important}.maqam-acc-item{border:1px solid rgba(200,164,90,.14)!important;border-radius:12px!important;background:rgba(255,255,255,.02)!important;overflow:hidden!important;transition:border-color .22s ease,background .22s ease,box-shadow .22s ease!important}.maqam-acc-item.is-open{border-color:rgba(200,164,90,.34)!important;background:rgba(200,164,90,.06)!important;box-shadow:0 10px 24px rgba(0,0,0,.16)!important}.maqam-acc-trigger{appearance:none!important;-webkit-appearance:none!important;width:100%!important;display:flex!important;align-items:center!important;justify-content:space-between!important;gap:12px!important;padding:14px 16px!important;border:none!important;outline:none!important;background:transparent!important;color:#e2c47e!important;font-family:'Cairo',sans-serif!important;font-size:1rem!important;font-weight:900!important;line-height:1.4!important;text-align:right!important;cursor:pointer!important}.maqam-acc-trigger span{color:inherit!important;font:inherit!important}.maqam-acc-trigger:hover{background:rgba(255,255,255,.03)!important;color:#f3ddab!important}.maqam-acc-trigger::before{content:'▾'!important;color:#c8a45a!important;font-size:.92rem!important;flex-shrink:0!important;transition:transform .22s ease,color .22s ease!important}.maqam-acc-item.is-open>.maqam-acc-trigger::before{transform:rotate(180deg)!important;color:#e2c47e!important}.maqam-acc-item[data-acc-level="sub"]>.maqam-acc-trigger{font-size:.95rem!important;font-weight:850!important;color:#ead19a!important;padding:12px 14px!important}.maqam-acc-panel{padding:0 16px 16px!important}.maqam-acc-item[data-acc-level="sub"]>.maqam-acc-panel{padding:0 14px 14px!important}.maqam-definition-summary{margin-bottom:10px!important}.maqam-content-top-grid{display:grid!important;grid-template-columns:minmax(0,1.35fr) minmax(320px,.95fr)!important;grid-template-areas:"info examples"!important;gap:14px!important;align-items:start!important}.maqam-content-col{min-width:0!important}.maqam-content-col-info{grid-area:info!important}.maqam-content-col-examples{grid-area:examples!important}.maqam-content-col>.maqam-content-card{margin:0!important}.jins-row{display:grid!important;gap:10px!important;margin-top:10px!important;direction:ltr!important}.jins-pill{min-height:40px!important;display:flex!important;align-items:center!important;justify-content:center!important;border-radius:12px!important;font-family:'Cairo',sans-serif!important;font-size:.95rem!important;font-weight:800!important;border:1px solid transparent!important;padding:0 8px!important;text-align:center!important;cursor:pointer!important;transition:background .18s ease,border-color .18s ease,box-shadow .18s ease,transform .18s ease!important}.jins-pill span{display:block!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;max-width:100%!important}.jins-pill-lower{background:rgba(200,164,90,0.08)!important;border-color:rgba(200,164,90,0.25)!important;color:#d8bb74!important}.jins-pill-upper{background:rgba(123,168,212,0.08)!important;border-color:rgba(123,168,212,0.25)!important;color:#8dbde4!important}.jins-pill-shared{background:rgba(112,170,96,0.12)!important;border-color:rgba(112,170,96,0.34)!important;color:#9fd68a!important}.jins-pill.is-selected{transform:translateY(-1px)!important}.jins-pill-lower.is-selected{background:rgba(200,164,90,0.18)!important;border-color:rgba(200,164,90,0.46)!important;box-shadow:0 0 0 2px rgba(200,164,90,0.16),0 10px 22px rgba(200,164,90,0.14)!important}.jins-pill-upper.is-selected{background:rgba(123,168,212,0.18)!important;border-color:rgba(123,168,212,0.46)!important;box-shadow:0 0 0 2px rgba(123,168,212,0.16),0 10px 22px rgba(123,168,212,0.14)!important}.jins-pill-shared.is-selected{background:rgba(112,170,96,0.20)!important;border-color:rgba(112,170,96,0.48)!important;box-shadow:0 0 0 2px rgba(112,170,96,0.16),0 10px 22px rgba(112,170,96,0.14)!important}.note-keys-row{direction:ltr!important}.note-key.jins-highlight .note-key-face{transform:translateY(-1px)!important}.note-key.jins-highlight-lower .note-key-face{background:rgba(200,164,90,0.20)!important;border-color:rgba(200,164,90,0.52)!important;color:#f0d28a!important;box-shadow:0 0 0 2px rgba(200,164,90,0.14),0 12px 24px rgba(200,164,90,0.18)!important}.note-key.jins-highlight-upper .note-key-face{background:rgba(123,168,212,0.20)!important;border-color:rgba(123,168,212,0.52)!important;color:#cde9ff!important;box-shadow:0 0 0 2px rgba(123,168,212,0.14),0 12px 24px rgba(123,168,212,0.18)!important}.note-key.jins-highlight-shared .note-key-face{background:rgba(112,170,96,0.22)!important;border-color:rgba(112,170,96,0.54)!important;color:#c7efb8!important;box-shadow:0 0 0 2px rgba(112,170,96,0.14),0 12px 24px rgba(112,170,96,0.18)!important}@media(max-width:900px){.maqam-content-top-grid{grid-template-columns:1fr!important;grid-template-areas:"info" "examples"!important}}@media(max-width:768px){.maqam-acc-trigger{font-size:.94rem!important;padding:12px 14px!important}.maqam-acc-item[data-acc-level="sub"]>.maqam-acc-trigger{font-size:.88rem!important;padding:11px 12px!important}.maqam-acc-panel{padding:0 14px 14px!important}.maqam-acc-item[data-acc-level="sub"]>.maqam-acc-panel{padding:0 12px 12px!important}.jins-row{gap:8px!important}.jins-pill{font-size:.84rem!important;min-height:38px!important;padding:0 6px!important}}`;
