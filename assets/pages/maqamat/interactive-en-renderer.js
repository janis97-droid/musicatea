...
(function () {
  ...
  function injectSharedEnglishMaqamStyles() {
    if (document.getElementById('maqam-accordion-theme-inline-en')) return;
    const s = document.createElement('style');
    s.id = 'maqam-accordion-theme-inline-en';
  ...
  function renderAll() {
    injectSharedEnglishMaqamStyles();
    renderSidebar();
    renderPageShell();
    ns.actions.syncUrl();
  }
